...
public final class MessageItemBinding implements ViewBinding {
  ...
  private MessageItemBinding(@NonNull LinearLayout rootView, @NonNull TextView messageText,
      @NonNull TextView senderText, @NonNull TextView timeText) {
  ...
  public static MessageItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new MessageItemBinding((LinearLayout) rootView, messageText, senderText, timeText);
    }
